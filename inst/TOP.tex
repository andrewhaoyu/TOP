...
three tumor characteristics. This decomposition is equivalent with the
first stage model. Since both the first stage and second stage have 8
parameters. We called this saturated model. The users could construct
